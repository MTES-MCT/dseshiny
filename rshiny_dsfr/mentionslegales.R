                    ...
                    tags$div(class="fr-col-12 fr-col-md-12 fr-col-lg-8",
                             ...
                             tags$div(class="fr-grid-row fr-grid-row--gutters",
                                      ...
                                      tags$div(class="content hentry", id="content",
                                               ...
                                               tags$p("Ministère de la Transition écologique", tags$br(class="autobr"),
                                                      "Commissariat général au développement durable", tags$br(class="autobr"),
                                                      "SDES/BSESE – Service des données et études statistiques", tags$br(class="autobr"),
                                                      "Bureau des synthèses économique et sociale sur l'environnement"),
                                               tags$h2(id="Liens-hypertextes-responsabilite", "Liens hypertextes (responsabilité)"),
                                               tags$p("publicite-responsable.ecologie.gouv.fr propose de nombreux liens vers d’autres sites publics (gouvernement, institutions, organismes publics, opérateurs….) et systématiquement identifiés. Cependant, ces pages web dont les adresses sont régulièrement vérifiées ne font pas partie du site publicite-responsable.ecologie.gouv.fr&nbsp;: elles n’engagent pas la responsabilité du CGDD."),
                                               ...
                                               tags$p("Le logo et les objets iconographiques du site publicite-responsable.ecologie.gouv.fr et la marque publicite-responsable.ecologie.gouv.fr sont la propriété exclusive du Commissariat général au développement durable (CGDD) à l’exception des ", tags$a(href="https://storyset.com/people", class="spip_out", rel="external", "Illustrations fournies par Storyset", ".")),
                                               tags$p("Les logos peuvent être utilisés par nos partenaires dans leur support de communication pour référencer les contenus ou liens vers le site publicite-responsable.ecologie.gouv.fr, à condition que “publicite-responsable.ecologie.gouv.fr” soit cité."),
                                               tags$p("L’ensemble des contenus sont réutilisables sous conditions de licence libre sans autorisation ni mention spécifique particulière outre celles définies dans le cadre de la licence ouverte. Les contenus du site peuvent être librement réutilisés, sous réserve de mentionner&nbsp;: la source (publicite-responsable.ecologie.gouv.fr), la date de création ou mise à jour du contenu. Les contenus relèvent de ", tags$a(href="https://www.etalab.gouv.fr/licence-ouverte-open-licence/", class="spip_out", rel="external", "la Licence ouverte"), "."),
